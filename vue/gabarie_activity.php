...
<?php for ($i=0;$i< count($lesinfos['activity']);$i ++): ?>
  <?php for ($j=0;$j< count($lesinfos['lesQuestions'][$i]);$j ++): ?>
    ...
    <div class="clearmarge" id="<?php echo 'act'. ($i + 1) . 'ex' . ($j + 1);?>">
        ...
        <textarea data-nom="pratiquePro" data-nombre="<?php echo $i; ?>" class="col-7 insertion" name="table5" type="text" placeholder="Cliquez ici pour entrer l'intitulé de l'activité"><?php echo $lesinfos['activity'][$i];?></textarea></div>
        ...
        <ol class="col-12">
            ...
            <input class="col-7 insertion" name="table6" type="text" <?php echo getPlacholder($lesinfos['lesQuestions'][$i][$j]['chant_at_serv']);?> placeholder="Cliquez ici pour taper du texte">
