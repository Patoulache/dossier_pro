...
<!--     <div class="clearmarge" id="<?php // echo 'act'. ($i + 1) . 'ex' . ($j + 1);?>">
        ...
        <textarea data-nom="pratiquePro" data-nombre="<?php // echo $i; ?>" class="col-7 insertion" type="text" placeholder="Cliquez ici pour entrer l'intitulé de l'activité"><?php // echo $lesinfos['activity'][$i];?></textarea></div>
        <div class="row"><label class="col-5">Exemple n°<?php // echo ($j +1).' '; ?><span class="littlepinkarrow">▶</span></label>
        <input class="col-7 insertion" type="text" <?php // echo getPlacholder($lesinfos['lesQuestions'][$i][$j]['exemple']);?> data-example="<?php // echo 'act'. $i +1 . 'ex' .$j +1;?>" placeholder="Cliquez ici pour entrer l'intitulé de l'exemple"></div>
        ...
        <ol class="col-12">
            ...
            <textarea class="col-12" name="table5" id="insertion" cols="30" rows="10" placeholder="Cliquez ici pour taper du texte"><?php // echo $lesinfos['lesQuestions'][$i][$j]['question3'];?></textarea>
            ...
            <input class="col-4 insertion" name="table5" type="text" <?php // echo getPlacholder($lesinfos['lesQuestions'][$i][$j]['question4']);?> placeholder="Cliquez ici pour taper du texte.">
            <label class="col-5">Chantier, atelier, service <span class="littlepinkarrow">▶</span></label>
            <input class="col-7insertion" name="table6" type="text" <?php // echo getPlacholder($lesinfos['lesQuestions'][$i][$j]['chant_at_serv']);?> placeholder="Cliquez ici pour taper du texte">
            <label class="col-4">Période d'exercice <span class="littlepinkarrow">▶</span></label>
            <span class="col-1">Du</span>
            <input class="col-3 insertion" name="table6" type="date" <?php // echo getPlacholder($lesinfos['lesQuestions'][$i][$j]['date_debut']);?>>
            <span class="col-1">au</span>
            <input class="col-3 insertion" name="table6" type="date" <?php // echo getPlacholder($lesinfos['lesQuestions'][$i][$j]['date_fin']);?>>

            <li class="col-12">Informations complémentaires (facultatif)</li>
            <textarea class="col-12" name="table5" id="insertion" cols="30" rows="10" placeholder="Cliquez ici pour taper du texte"><?php //echo $lesinfos['lesQuestions'][$i][$j]['question5'];?></textarea>
        </ol>
    </div>
 -->  <?php // endfor;?>
<?php // endfor;?>
...
<?php ob_start(); ?>
<div class="clearmarge" id="echo 'act'. ($i + 1) . 'ex' . ($j + 1);">
    ...
    <ol class="col-12">
        ...
        <li class="col-12">Contexte</li>
        <label class="col-8">Nom de l'entreprise, organisme ou association<span class="littlepinkarrow">▶</span></label>
        <input class="col-4 insertion" name="table5" type="text" placeholder="Cliquez ici pour taper du texte.">
        <label class="col-5">Chantier, atelier, service <span class="littlepinkarrow">▶</span></label>
        <input class="col-7 insertion" name="table6" type="text" placeholder="Cliquez ici pour taper du texte">
        <label class="col-4">Période d'exercice <span class="littlepinkarrow">▶</span></label>
        <span class="col-1">Du</span>
        <input class="col-3 insertion" name="table6" type="date" placeholder="Cliquez ici">
        <span class="col-1">au</span>
        <input class="col-3 insertion" name="table6" type="date" placeholder="Cliquez ici">
